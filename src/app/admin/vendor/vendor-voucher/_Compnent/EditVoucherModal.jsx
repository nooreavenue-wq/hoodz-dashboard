...
import { selectToken } from "@/redux/features/authSlice"; // adjust
...
export default function EditVoucherModal({ open, setOpen, voucherId }) {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      toast.error(e?.data?.message || "Failed to update voucher");
    }
  };
